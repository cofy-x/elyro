...
- `check-release-inputs.sh`: verifies exact release inputs and five-image definitions.
- `build-core-images.sh` / `smoke-core-images.sh`: builds and validates all five Workspace images for one explicit platform.
...
scripts/ci/check-release-inputs.sh v0.1.3
