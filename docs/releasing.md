...
- `checksums.txt`, archive SBOMs, provenance attestations, and a prerelease GitHub Release;
- five signed multi-architecture images: `workspace-base`, `workspace-python`, `workspace-go`, `workspace-node`, and `workspace-java`;
